...
## Corpus Check
- 698 files · ~711,985 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2273 nodes · 3566 edges · 50 communities detected
...
- `handleLogout()` --calls--> `logout()`  [INFERRED]
  workspaces/design-system/src/components/layout/Header.tsx → workspaces/twitter/src/auth/authApi.ts
...
Cohesion: 0.02
Nodes (39): TestElementInternals, ButtonHarness, MdAssistChip, MdChipSet, MdFilterChip, ChipHarness, MdInputChip, MdSuggestionChip (+31 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (48): ariaPropertyToAttribute(), isAriaAttribute(), ariaAttributeToDataAttribute(), ariaAttributeToDataProperty(), mixinDelegatesAria(), setupDelegatesAriaProperties(), DelegatesAriaElement, setupTest() (+40 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (23): MdElevatedButton, MdFilledButton, MdFilledTonalButton, MdOutlinedButton, MdTextButton, MdIconButton, ElevatedButton, FilledButton (+15 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (35): createActivateTypeaheadEvent(), createDeactivateTypeaheadEvent(), isClosableKey(), SurfacePositionController, TypeaheadController, ListController, activateFirstItem(), activateLastItem() (+27 more)
...
Cohesion: 0.03
Nodes (10): MdCheckbox, Radio, Switch, TestTextField, RadioHarness, MdRadio, SwitchHarness, MdSwitch (+2 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (17): renderSwitch(), renderSwitchInForm(), renderSwitchInLabel(), switchElement(), switchInForm(), TestSwitch, ListItemHarness, MenuHarness (+9 more)
...
Cohesion: 0.05
Nodes (45): AuthApiError, confirmOtp(), fetchCurrentUser(), fetchProfileRequirements(), fetchSession(), logout(), parseErrorMessage(), requestOtp() (+37 more)
...
- **Why does `setupDispatchHooks()` connect `Community 2` to `Community 10`, `Community 6`, `Community 22`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `setupButton()` connect `Community 10` to `Community 2`?**
