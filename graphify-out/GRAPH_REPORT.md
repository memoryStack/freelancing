...
## Corpus Check
- 701 files · ~712,508 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2285 nodes · 3592 edges · 46 communities detected
...
- `LoginPage()` --calls--> `useAuth()`  [INFERRED]
  workspaces/twitter/src/pages/login/index.tsx → workspaces/twitter/src/auth/AuthContext.tsx
...
- `fetchSession()` --calls--> `parseMeResponse()`  [INFERRED]
  workspaces/design-system/src/auth/authApi.ts → workspaces/design-system/src/auth/session.ts

## Communities (226 total, 12 thin omitted)
...
Cohesion: 0.02
Nodes (29): MdElevatedButton, MdFilledButton, MdFilledTonalButton, MdOutlinedButton, MdTextButton, MdCheckbox, MdIconButton, ElevatedButton (+21 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (49): ariaPropertyToAttribute(), isAriaAttribute(), ariaAttributeToDataAttribute(), ariaAttributeToDataProperty(), mixinDelegatesAria(), setupDelegatesAriaProperties(), mixinConstraintValidation(), TestConstraintValidation (+41 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (32): DelegatesAriaElement, setupTest(), TestElementInternals, ButtonHarness, MdChipSet, ChipHarness, MdIcon, IconButtonHarness (+24 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (37): createActivateTypeaheadEvent(), createDeactivateTypeaheadEvent(), isClosableKey(), isElementInSubtree(), SurfacePositionController, TypeaheadController, ListController, activateFirstItem() (+29 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (52): App(), AuthApiError, confirmOtp(), fetchCurrentUser(), fetchProfileRequirements(), fetchSession(), logout(), parseErrorMessage() (+44 more)
...
Cohesion: 0.04
Nodes (39): MenuItemController, isSelectableKey(), dispatchInteractionEvents(), firstUpdated(), formResetCallback(), getErrorText(), getRenderClasses(), getSelectedOptions() (+31 more)
...
Cohesion: 0.05
Nodes (31): focus(), formResetCallback(), getErrorText(), getInput(), getInputOrTextarea(), [onReportValidity](), render(), renderAffix() (+23 more)
...
Cohesion: 0.06
Nodes (7): cardClasses(), CardDirective, Card, AttachableController, FocusRing, Ripple, TestRipple

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (8): List, ListHarness, MdListItem, MdList, ListItemHarness, ListItemEl, MenuHarness, MenuItemHarness

### Community 16 - "Community 16"
Cohesion: 0.07
Nodes (8): MdDivider, Divider, shouldReduceMotion(), Tab, isTab(), Tabs, TabHarness, TabsHarness
...
Cohesion: 0.08
Nodes (9): Switch, renderSwitch(), renderSwitchInForm(), renderSwitchInLabel(), switchElement(), switchInForm(), TestSwitch, SwitchHarness (+1 more)

### Community 22 - "Community 22"
Cohesion: 0.11
Nodes (16): ApiClient, resolveOptions(), shouldPublishSessionExpired(), showErrorSnackbar(), showSuccessSnackbar(), splitConfig(), ApiClientError, defaultErrorMessage() (+8 more)
...
Cohesion: 0.11
Nodes (4): MdFilledIconButton, MdFilledTonalIconButton, MdOutlinedIconButton, IconButton
...
- **Why does `setupDispatchHooks()` connect `Community 2` to `Community 8`, `Community 24`, `Community 21`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `setupButton()` connect `Community 8` to `Community 2`?**
